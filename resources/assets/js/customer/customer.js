...
var _form = document.getElementById('customer_form');
			...
			return {
				...
				thumbnails: {
					...
					onItemRemove: function(itemEl, listEl, parentEl, newInputEl, inputEl) {
						...
						// post delete
						customer.$attachmentDeleteForm.find('input[name=_meta]').val( itemEl.data('meta') );

						$.ajax({
							url: '/deals/attachment/delete',
							type: 'POST',
							data: customer.$attachmentDeleteForm.serialize(),
