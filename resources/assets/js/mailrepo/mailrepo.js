...
$(document).ready(function(){
	...
	var oTable =  $('.non-custom-datatable').DataTable({
		// searching: false
	});
	...
	yadcf.init(oTable,[
	  {column_number : 2,  filter_container_id: 'mbox', filter_reset_button_text:false, style_class:'form-control', filter_default_label:''},
	  {column_number : 3,  filter_container_id: 'mailer', filter_reset_button_text:false, style_class:'form-control', filter_default_label:''},
	  {column_number : 5,  filter_container_id: 'maileto', filter_reset_button_text:false, style_class:'form-control', filter_default_label:''}
