                ...
                <div class="form-wrapper">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group position-relative">
                            ...
                            <label for="" class="form-label" style=""><i class="fas fa-key"></i> {{ __('Confirm Password') }}</label>
                        </div>

                        <div class="form-group mb-0">
                            <button type="submit" class="btn btn-primary border-radius-0 w-100">{{ __('Reset Password') }}</button>
                        </div>
                    </form>
                </div>
            </div>
