                ...
                <div class="form-padding-left-right form-template">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="reason-1">Medical Grounds</label>

                        <div class="crm-form-radio position-relative display-inlineblock">
                          <input type="radio" class="" id="reason-2" name="reason-for-request">
                          <label class="radio-input" for="reason-2"></label>
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="reason-2">Exceptional Reasons</label>

                        <div class="crm-form-radio position-relative display-inlineblock">
                          <input type="radio" class="" id="reason-3" name="reason-for-request">
                          <label class="radio-input" for="reason-3"></label>
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="reason-3">Change of mind</label>

                        <div class="crm-form-radio position-relative display-inlineblock">
                          <input type="radio" class="" id="reason-4" name="reason-for-request">
                          <label class="radio-input" for="reason-4"></label>
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="reason-4">Other</label>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <small class="px-12-font no-margin">Note: International students must state the reason and provide documentation for deferring their studies as ETI needs to notify this information to the Department of Home Affairs via PRISMS.</small>
                      </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="document-1">Medical Certificate</label>

                        <div class="crm-form-checkbox position-relative display-inlineblock">
                          <input type="checkbox" class="" id="document-2" name="documents-attached">
                          <label class="checkbox-input" for="document-2"></label>
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="document-2">Travel Documents</label>

                        <div class="crm-form-checkbox position-relative display-inlineblock">
                          <input type="checkbox" class="" id="document-3" name="documents-attached">
                          <label class="checkbox-input" for="document-3"></label>
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="document-3">Mails</label>

                        <div class="crm-form-checkbox position-relative display-inlineblock">
                          <input type="checkbox" class="" id="document-4" name="documents-attached">
                          <label class="checkbox-input" for="document-4"></label>
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="document-4">Supporting certificates</label>
                ...
                <div class="form-padding-left-right form-template">
                    ...
                    <div class="col-lg-2">
                      <div class="form-group">
                        ...
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="deferment">Deferment</label>
                      </div>
                    </div>
                    <div class="col-lg-5">
                      <div class="form-group">
                    ...
                    <div class="col-lg-2">
                      <div class="form-group">
                        ...
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="suspension">Suspension</label>
                      </div>
                    </div>
                    <div class="col-lg-5">
                      <div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        </div> <label class="display-inlineblock px-12-font checkbox-label label-right not-required" for="cancellation">Cancellation/withdrawal Date effective from</label>
                      </div>
                    </div>
                    <div class="col-lg-5">
                      <div class="form-group">
